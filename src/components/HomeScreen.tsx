  ...
  return (
    <main className='flex flex-col justify-center items-center px-8 py-12 text-center'>
      <div className='max-w-4xl w-full space-y-8 lg:space-y-12'>
        ...
        <section className='grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 max-w-4xl mx-auto items-stretch'>
          <Link to='/sender' className='block w-full'>
            <div className='h-full flex flex-col justify-center items-center gap-2 p-4 rounded-xl bg-background border border-primary hover:border-secondary transition-all'>
              <FaWarehouse className='text-4xl lg:text-5xl text-primary' />
              <p className='font-semibold text-text-dark'>Lager (Avsändare)</p>
            </div>
          </Link>

          <Link to='/driver' className='block w-full'>
            <div className='h-full flex flex-col justify-center items-center gap-2 p-4 rounded-xl bg-background border border-primary hover:border-secondary transition-all'>
          ...
          <Link to='/recipient' className='block w-full'>
            <div className='h-full flex flex-col justify-center items-center gap-2 p-4 rounded-xl bg-background border border-primary hover:border-secondary transition-all'>
